...
// Create markers for the Spring Uber Unit Locations
...
function initVehicles() {
    ...
    // processing - spin!
    $("#spinnerIcon").show();
    collectPages('/location-service/locations', function (result) {
...
function createServiceCenterPopup(data) {
    return "<div class='scg_popup'>"
        + "<div class='loc_header'><i class='fa fa-wrench'></i>Spring Uber Service Center</div>"
